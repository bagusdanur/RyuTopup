...
import { FiGrid, FiBox, FiTag, FiShoppingCart, FiSettings, FiLogOut } from "react-icons/fi";
...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col md:flex-row antialiased font-sans selection:bg-accent selection:text-black">
      
      {/* SIDEBAR */}
      <aside className="w-full md:w-72 bg-black border-b-4 md:border-b-0 md:border-r-4 border-white flex flex-col shrink-0 relative z-10">
      ...
      {/* MAIN CONTENT AREA */}
      <main className="flex-1 relative overflow-y-auto bg-[#0a0a0a]">
