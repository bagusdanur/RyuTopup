    ...
    >
      ...
      {!outOfStock && (
        <div className="flex items-center gap-1.5 mt-3 w-full border-t pt-2 border-white/20">
          ...
          {/* Instan SVG Badge exactly as requested */}
          <div className="h-fit w-fit rounded bg-white p-1 ml-auto">
            <svg width="52" height="16" viewBox="0 0 52 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-3 w-12">
              <path fillRule="evenodd" clipRule="evenodd" d="M8.57048 14.7439C8.6248 14.8408 8.70983 14.9168 8.81215 14.96C8.87414 14.9852 8.94024 14.9987 9.00714 15C9.08564 14.9969 9.1623 14.9754 9.23093 14.9372C9.29956 14.899 9.35821 14.8451 9.40214 14.78L15.9021 6.28011C15.9546 6.20906 15.9873 6.12536 15.997 6.03753C16.0067 5.94971 15.9929 5.86089 15.9571 5.78012C15.9158 5.69597 15.8518 5.6251 15.7722 5.57559C15.6926 5.52608 15.6008 5.49993 15.5071 5.50012H13.1321L13.9971 1.61017C14.0136 1.53638 14.0132 1.4598 13.9959 1.38618C13.9786 1.31257 13.9448 1.24384 13.8971 1.18518C13.85 1.12717 13.7906 1.08044 13.7231 1.04842C13.6556 1.01641 13.5818 0.999925 13.5071 1.00018H8.50715C8.39226 0.997107 8.27981 1.03371 8.18875 1.10383C8.09768 1.17396 8.03355 1.27331 8.00716 1.38517L7.63451 3H0V4.33333H7.32681L6.86527 6.33333H1.33334V7.66667H6.55758L6.50718 7.88509C6.48953 7.95962 6.48925 8.03721 6.50634 8.11186C6.52344 8.18652 6.55745 8.25625 6.60577 8.31568C6.65408 8.37511 6.7154 8.42264 6.785 8.45461C6.8546 8.48659 6.93061 8.50214 7.00717 8.50008H9.42214L9.24297 9.66667H6V11H9.03819L8.51215 14.425C8.49564 14.5348 8.51616 14.647 8.57048 14.7439ZM3.33334 9.66667H5.33334V11H3.33334V9.66667Z" fill="#285346"></path><path d="M20.582 5.042C20.482 5.042 20.408 5.01 20.36 4.946C20.316 4.882 20.3 4.794 20.312 4.682L20.888 1.076C20.904 0.972 20.942 0.896 21.002 0.848C21.062 0.796 21.142 0.77 21.242 0.77H22.514C22.962 0.77 23.306 0.868 23.546 1.064C23.786 1.26 23.906 1.548 23.906 1.928C23.906 2.368 23.768 2.716 23.492 2.972C23.216 3.228 22.814 3.356 22.286 3.356H21.476L20.924 4.736C20.908 4.84 20.872 4.918 20.816 4.97C20.76 5.018 20.682 5.042 20.582 5.042ZM21.224 2.858H22.322C22.642 2.858 22.884 2.782 23.048 2.63C23.216 2.478 23.3 2.258 23.3 1.97C23.3 1.73 23.228 1.554 23.084 1.442C22.944 1.326 22.732 1.268 22.448 1.268H21.476L21.224 2.858Z" fill="#285346"></path><path d="M20.896 15.072C20.6827 15.072 20.5307 15.008 20.44 14.88C20.3493 14.7467 20.3227 14.5653 20.36 14.336L21.064 9.912C21.096 9.704 21.1707 9.54933 21.288 9.448C21.4053 9.34133 21.5653 9.288 21.768 9.288C21.976 9.288 22.1227 9.352 22.208 9.48C22.2987 9.608 22.3253 9.78933 22.288 10.024L21.584 14.44C21.552 14.648 21.48 14.8053 21.368 14.912C21.256 15.0187 21.0987 15.072 20.896 15.072Z" fill="#285346"></path>
            </svg>
          </div>
        </div>
      )}
